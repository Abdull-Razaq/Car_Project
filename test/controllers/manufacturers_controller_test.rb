...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { country_of_origin: @manufacturer.country_of_origin, name: @manufacturer.name } }, as: :json
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { country_of_origin: @manufacturer.country_of_origin, name: @manufacturer.name } }, as: :json
    assert_response :success
  end
